 ...
 * placeholders; a placeholder matches one non-slash segment and is passed
 * to the controller action as a string argument in declaration order.
 */
final class Router
{
    /** @var list<array{method: string, pattern: string, regex: string, handler: array{class-string, string}}> */
    ...
    /**
     * Resolve and invoke the matching controller action.
     * Emits 404 for no path match and 405 for a method mismatch.
     */
