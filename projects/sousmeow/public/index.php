...
// real files (css, fonts, images) back to it. Apache does this via the
// RewriteCond in .htaccess instead.
...
// style-src allows inline style attributes: progress ring geometry and
// watercolor accents are computed server-side per page. Scripts stay
// 'self' only, which is the part of CSP that blunts XSS.
