...
/**
 * CLI smoke test: Money Collection Cookbooks end-to-end without a browser.
 * For each Money Cookbook: create a project, fill pantry sample values,
 * paste each example_response, confirm checks, approve, then export kit.
 *
 * Usage: php scripts/verify-money-collection.php
 */
...
echo "Money Collection verification passed.\n";
